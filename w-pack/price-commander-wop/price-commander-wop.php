...
Text Domain: price-commander-wop
*/
...
if ( !class_exists( 'wop_PriceCommander' ) ) :

	final class wop_PriceCommander {
		...
		public function __construct() {
			do_action( 'price_commander_wop_loading' );
			...
			do_action( 'price_commander_wop_loaded' );
		}
	...
	function wop_PriceCommander() {
		return wop_PriceCommander::instance();
	}

	wop_PriceCommander::instance();
