...
if ( !class_exists( 'wop_LiveSearch' ) ) :

	final class wop_LiveSearch {
		...
		public function __construct() {
			do_action( 'live_search_wop_loading' );
			...
			do_action( 'live_search_wop_loaded' );
		}
	...
	function wop_LiveSearch() {
		return wop_LiveSearch::instance();
	}

	wop_LiveSearch::instance();
