...
(function($) {
    ...
    $(document).on('click', '.prdctfltr_woocommerce_filter', function() {
        ...
        if (btn.hasClass('prdctfltr_active')) {
            ...
            f.removeClass('wpc--pf-show-sidebar');
            ...
            f.addClass('wpc--pf-show-sidebar');
    ...
    function closeEverything() {
        ...
        $('.prdctfltr_woocommerce_ordering.wpc--pf-show-sidebar').removeClass('wpc--pf-show-sidebar');
    ...
    function loaderPlayAnimation(f) {
        $('body').append('<div class="wpc--pf-loader-overlay"></div>');
    }

    function loaderStopAnimation(f) {
        $('.wpc--pf-loader-overlay').remove();
    }

    function loaderPlayTitleAnimation(f) {
        f.addClass('wpc--pf-loading');
    }
    ...
    function ACVariableAddOutOfStock() {
        $(prdctfltr.ajax_product_class+".instock.post-"+prdctfltr.active_filtering.inactive_parents.join(", .post-")).removeClass('instock').addClass('out-of-stock').find('a img.attachment-woocommerce_thumbnail').before('<span class="wpc--pf-outofstock">'+prdctfltr.localization.outofstock+'</span>');
    }
    ...
    function ACVariableAddBadges() {
        $(prdctfltr.ajax_product_class+'.out-of-stock a img.attachment-woocommerce_thumbnail').before('<span class="wpc--pf-outofstock">'+prdctfltr.localization.outofstock+'</span>');
    }
