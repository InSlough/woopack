...
class wop_Product_Filters_Themes {
	...
	public static function get_theme() {
		...
		if ( method_exists( 'wop_Product_Filters_Themes', '__options_for_' . $ajax['template'] ) ) {
			$themeAjax = call_user_func( 'wop_Product_Filters_Themes::__options_for_' . $ajax['template'] );
			if ( !empty( $themeAjax ) ) {
